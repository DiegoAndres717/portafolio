...
const CardProyect = ({ proyectos }) => {
  ...
  if (proyectos.length === 1) {
    gridColumns = "md:grid-cols-1";
  } else if (proyectos.length === 2) {
        ...
        >
          ...
          <div className="content">
            <Link
              href={card.urlGit}
              target="_blank"
              className="hover:border-2 hover:rounded-lg font-bold py-2 px-4 rounded inline-flex items-center"
            >
              <figure className="social-button github">
                <svg
